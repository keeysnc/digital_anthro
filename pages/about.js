	...
	return (
		<div className={aboutStyles.about}>
			...
			<PageTitle
				title="About"
				textTitle=""
				textDescription="Digital Anthro is a creative studio, front-end web development consultancy. The studio was founded in 2018 due to the emergence and maturity of interactive and immersive technologies on the web. Digital Anthro's mission is one of design, technology and human behavior. The mission is simply to explore modern methods of web interaction and how they can better the digital human experience."
			></PageTitle>
