			...
			<div className={serviceStyles.services__grid}>
				<div className={serviceStyles.services__grid__item}>
					<ParagraphText
						...
						textDescription="Digital Anthro builds interactive experiences, websites, stores and apps utilizing full-stack javascript development and modern web practices."
					></ParagraphText>
				</div>
				<div className={serviceStyles.services__grid__item}>
					<ParagraphText
						textTitle="Headless CMS Implementation"
						textDescription="Digital Anthro works with clients who are in need of easily maintainable and flexible content management system solutions."
				...
				<div className={serviceStyles.services__grid__item}>
					<ParagraphText
						textTitle="UI/UX/Interaction Strategy & Design"
